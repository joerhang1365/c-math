...
{
   vector3 resultant;
   vector3_create(&resultant, a.j * b.k - a.k * b.j, a.i * b.k - a.k * b.i, a.i * b.j - a.j * b.i);
   return resultant;
}

char *vector3_toString(vector3 vec3)
{
   char *string = malloc(29);
   sprintf(string, "%1fi + %1fj + %1fk", vec3.i, vec3.j, vec3.k);
   return string;
}
